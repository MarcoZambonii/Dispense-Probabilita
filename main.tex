...
{\Huge\textsc{Dispense di Probabilità}}\\
\vspace*{1cm}
{\Large A cura di Marco Zamboni}
...
\include{Dispense_Integrative/calcolo_combinatorio}
\include{Dispense_Integrative/complex_log}
\include{Dispense_Integrative/sqrt_matrix}

\chapter{Distribuzioni Discrete}
\include{Distribuzioni/Discrete/Uniforme_disc} 
\include{Distribuzioni/Discrete/Bernoulli}
\include{Distribuzioni/Discrete/Binomiale}
\include{Distribuzioni/Discrete/Poisson}
\include{Distribuzioni/Discrete/Geometrica}
\include{Distribuzioni/Discrete/Ipergeometrica}

\chapter{Distribuzioni Continue}
\include{Distribuzioni/Continue/Uniforme_cont}
\include{Distribuzioni/Continue/Esponenziale}
\include{Distribuzioni/Continue/Normale}
\include{Distribuzioni/Continue/Gamma}
